...
class NublyOptionsFlow(OptionsFlow):
    ...
    async def async_step_media(self, user_input=None):
        ...
        # Favorites are auto-discovered from the selected media_player if
        # it belongs to the Sonos integration. The user only chooses
        # whether to expose them and how many to show.
        schema_dict[
            vol.Optional(
                "favorites_enabled",
